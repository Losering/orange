...
import (
	...
	"orange/apps/user/rpc/internal/logic"
...
// 注册
func (s *UserServer) Regist(ctx context.Context, in *user.RegistRequest) (*user.RegistResponse, error) {
	l := logic.NewRegistLogic(ctx, s.svcCtx)
	return l.Regist(in)
}
