...
type (
	...
	RegistRequest             = user.RegistRequest
	RegistResponse            = user.RegistResponse
...
// 注册
func (m *defaultUser) Regist(ctx context.Context, in *RegistRequest, opts ...grpc.CallOption) (*RegistResponse, error) {
	client := user.NewUserClient(m.cli.Conn())
	return client.Regist(ctx, in, opts...)
}
